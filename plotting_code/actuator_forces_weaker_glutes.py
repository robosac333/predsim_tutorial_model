...
# %% Plotting augmented actuator forces
plt.figure(figsize=(10, 6))
plt.plot(augmented_data['time'], augmented_data['ankle_angle'], label='Actuator Force')
plt.xlabel('Time [s]')
...
file_path = r"C:\Users\sachi\predsim_tutorial_model\OpenSimModel\Newmodelextendablegait\Model\results_augmented.csv"
...
plt.figure(figsize=(10, 6))
plt.plot(result['time'], actuator_force, label='Actuator Force')
plt.xlabel('Time [s]')
plt.ylabel('Force [N]')  # Changed to reflect force units
plt.legend()
plt.title('Actuator Force over Time')
